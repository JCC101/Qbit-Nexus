...
# --- 图标定义 (SVG Data URI) ---
# 这是一个蓝色的圆角图标，内置了白色层叠形状，匹配 UI 主题
FAVICON_URI = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect x='0' y='0' width='32' height='32' rx='8' fill='%230ea5e9'/%3E%3Cpath d='M16 6 L26 11 L16 16 L6 11 Z M6 13 L16 18 L26 13 M6 19 L16 24 L26 19' fill='none' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E"
